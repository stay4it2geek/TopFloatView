 ...
 */
public class ImageViewpagerView extends RelativeLayout {
    ...
    public ImageViewpagerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ImageViewpagerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ImageViewpagerView);

        mPointsIsVisible = a.getBoolean(R.styleable.ImageViewpagerView_points_visibility, true);
        mPointPosition = a.getInt(R.styleable.ImageViewpagerView_points_position, CENTER);
        mPointContainerBackgroundDrawable
                = a.getDrawable(R.styleable.ImageViewpagerView_points_container_background);
    ...
    private void setLayout(Context context) {
        ...
        //设置内边距
        pointContainerRl.setPadding(0, 10, 0, 8);
        //设定指示器容器布局及位置
    ...
    public void setLoadViewName(boolean isBanner) {
    ...
    private class FlyPageAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            BanerNetworkImage imageView = new BanerNetworkImage(getContext());
            ...
            imageView.setDefaultImageResId(R.drawable.img_loading);
            imageView.setImageUrlOfBanner(mImageUrls.get(toRealPosition(position)), ImageDownLoader.getInstance(getContext()), false);
